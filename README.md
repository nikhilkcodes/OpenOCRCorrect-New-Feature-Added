# OpenOCRCorrect-New-Feature-Added
...
1. I've put an Edit button to the toolbar.
2. After selecting the Edit option, you will be presented with four options:
    
    Bold: This will make a specific word bold.
    
    Unbold: This will unbold a single sentence.
    
    Superscript: will create a single line of text superscript.
    
    Subscript: makes a single word subscript.
